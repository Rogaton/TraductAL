...
# Create interface with model selection and file upload
with gr.Blocks(title="TraductAL Progressive v2", theme=gr.themes.Default()) as demo:
    gr.Markdown("# 🌐 TraductAL - Multi-Model Translation (Progressive v2)")
    gr.Markdown("*Now with file upload support*")
    ...
    clear_btn.click(
        fn=clear_fields,
        outputs=[text_input, output, file_upload]
    )
