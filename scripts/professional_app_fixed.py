...
from fixed_multi_model_translator import MultiModelTranslator
import PyPDF2
import docx
import json
...
with gr.Blocks(title="TraductAL Professional - Fixed", theme=gr.themes.Soft()) as demo:
    gr.Markdown("# 🌐 TraductAL Professional - Multi-Model Translation Suite (Fixed)")
